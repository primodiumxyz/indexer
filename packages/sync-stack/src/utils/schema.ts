...
const whereClauseSchema = z.object({
  ...
  value: z.union([z.bigint(), z.custom<Hex>(), z.number()]).transform((val) => val.toString()),
});
...
//https://github.com/latticexyz/mud/blob/main/packages/store-sync/src/indexer-client/input.ts
